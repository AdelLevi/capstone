...
public class JoystickEditor : Editor
{
	...
	private SerializedProperty HoldInputX;
	private SerializedProperty HoldInputY;
    ...
    protected virtual void OnEnable()
    {
	    ...
	    HoldInputX = serializedObject.FindProperty("HoldInputX");
	    HoldInputY = serializedObject.FindProperty("HoldInputY");
    ...
    protected virtual void DrawValues()
    {
	    ...
	    EditorGUILayout.PropertyField(HoldInputX, new GUIContent("Hold Input X", "Freeze input on X."));
	    EditorGUILayout.PropertyField(HoldInputY, new GUIContent("Hold Input Y", "Freeze input on Y."));
    }
